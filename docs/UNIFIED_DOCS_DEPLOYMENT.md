...
├── typescript/             # TypeDoc generated docs
│   └── (generated by TypeDoc)
└── go/                     # Go docs (pkgsite or godoc)
    └── (generated by pkgsite)
```
      ...
      - name: Create unified docs
        run: |
          ...
          <body>
            ...
            <div class="section">
              <h2>📘 TypeScript API Documentation <span class="badge">proton-drive-cli</span></h2>
            ...
            <div class="section">
              <h2>📗 Go API Documentation <span class="badge">proton-git-lfs</span></h2>
...
1. Check repository settings → Pages → Source
