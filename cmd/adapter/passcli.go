...
func (a *Adapter) resolveSDKCredentials() error {
	...
	if strings.TrimSpace(a.protonUsername) == "" && strings.TrimSpace(a.protonPassUserRef) != "" {
	...
	if strings.TrimSpace(a.protonPassword) == "" && strings.TrimSpace(a.protonPassPassRef) != "" {
